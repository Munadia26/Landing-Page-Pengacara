      ...
      <div className="container mx-auto px-6 md:px-12 lg:px-24 grid lg:grid-cols-2 gap-12 items-center relative z-10 pt-40 lg:pt-44 pb-20">
        ...
        <div className="space-y-8 animate-in fade-in slide-in-from-left duration-1000 order-2 lg:order-1">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <a href="#layanan" className="btn-outline-gold text-center !text-white !border-white/30 hover:!bg-white/10 flex items-center justify-center px-8 py-4 rounded-xl transition-all">
              Pelajari Layanan
            </a>
          </div>
        </div>
        ...
        <div className="relative animate-in fade-in slide-in-from-right duration-1000 order-1 lg:order-2">
          <div className="relative z-10 rounded-2xl overflow-hidden border-8 border-white/5 shadow-2xl group">
            <img 
              src={advocate.image} 
              alt={advocate.name}  
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-[#0f1c2e] to-transparent p-8">
              <div className="bg-[hsl(var(--gold))] inline-block px-4 py-1 rounded-sm mb-2">
                <span className="text-[10px] font-bold uppercase tracking-widest text-[#0f1c2e]">Professional Advocate</span>
